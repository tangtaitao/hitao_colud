...
public class GatewayApiDefineServiceImpl implements GatewayApiDefineService{
	 ...
	 * @return
	 */
	public ServerResponse<LayuiEntity<GatewayApiDefine>> selectGatewayApiDefine(Map<String, Object> map ) {
		List<GatewayApiDefine> shopBrands = mapper.selectGatewayApiDefine(map);
		PageInfo<GatewayApiDefine> info = new PageInfo<>(shopBrands);
